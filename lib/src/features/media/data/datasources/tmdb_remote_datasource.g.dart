...
part of 'tmdb_remote_datasource.dart';
...
class _TmdbRemoteDataSource implements TmdbRemoteDataSource {
  ...
  Future<MediaModel> getMovieDetails(
    ...
    final _options = _setStreamType<MediaModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late MediaModel _value;
    try {
      _value = MediaModel.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<Map<String, dynamic>> getTrending(String language) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<Map<String, dynamic>> getPopularMovies(String language) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'language': language};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<Map<String, dynamic>> getPopularTvShows(String language) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'language': language};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
